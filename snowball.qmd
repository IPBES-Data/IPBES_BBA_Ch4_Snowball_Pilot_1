...
params:
    key_paper: "Updated paper list snowballing.csv"
---
...
# Back to [Readme](https://rkrug.github.io/IPBES_BBA_Ch4_Snowball_Pilot_1/)
...
if ((list.files("figures") |> length()) < 4) {
    x <- plot_snowball(
        snowball,
        name = "Snowball Pilot"
    )
...
![](figures/Snowball Pilot_cited_by_count_by_year.png)
[Right click - Download for (better quality)](figures/Snowball Pilot_cited_by_count_by_year.pdf)
